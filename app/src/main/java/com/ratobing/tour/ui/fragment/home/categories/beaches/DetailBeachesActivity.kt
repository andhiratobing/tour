...
class DetailBeachesActivity: AppCompatActivity()  {

    private lateinit var binding: ActivityDetailTripsBinding

    companion object{
        const val EXTRA_TOUR_DATA_BEACHES = "extra_tour_data_beaches"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val data: TourData = intent.getParcelableExtra(EXTRA_TOUR_DATA_BEACHES)!!
        ...
        binding.apply {
            ...
            Glide.with(this@DetailBeachesActivity)
