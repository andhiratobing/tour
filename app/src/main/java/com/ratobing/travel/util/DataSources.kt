package com.ratobing.travel.util
...
object DataSources{
    ...
    fun setBeaches(): ArrayList<TravelData>{
        val list = ArrayList<TravelData>()
        list.add(
            TravelData(
                category = "Beach",
